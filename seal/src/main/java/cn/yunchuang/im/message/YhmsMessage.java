...
@MessageTag(value = "RCD:YhmsMsg", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class YhmsMessage extends MessageContent {
    ...
    public static YhmsMessage obtain(String text) {
        YhmsMessage model = new YhmsMessage();
        model.setContent(text);
        return model;
    }

    public YhmsMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public static final Creator<YhmsMessage> CREATOR = new Creator<YhmsMessage>() {

        @Override
        public YhmsMessage createFromParcel(Parcel source) {
            return new YhmsMessage(source);
        }

        @Override
        public YhmsMessage[] newArray(int size) {
            return new YhmsMessage[size];
        }
    };
     ...
     */
    public YhmsMessage(String content) {
