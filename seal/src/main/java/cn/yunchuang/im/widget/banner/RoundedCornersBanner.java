...
import cn.yunchuang.im.widget.RoundImageView;
...
public class RoundedCornersBanner extends FrameLayout implements OnPageChangeListener {
    ...
    public RoundedCornersBanner(Context context) {
        this(context, null);
    }

    public RoundedCornersBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundedCornersBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    public RoundedCornersBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public RoundedCornersBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public RoundedCornersBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public RoundedCornersBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public RoundedCornersBanner setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public RoundedCornersBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public RoundedCornersBanner setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public RoundedCornersBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public RoundedCornersBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public RoundedCornersBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public RoundedCornersBanner setImages(List<?> imageUrls) {
    ...
    public RoundedCornersBanner start() {
        setBannerStyleUI();
...
//            setScaleType(imageView);
            ...
            if (url instanceof View) {
                ...
                view = View.inflate(context, R.layout.t_banner_ad_layout_round_corner, null);
                RoundImageView roundImageView = (RoundImageView) view.findViewById(R.id.iv);
                roundImageView.setTag(R.id.banner_tag_first, 0);
            }
...
//                }
    ...
    public RoundedCornersBanner setOnBannerClickListener(OnBannerClickListener listener) {
...
//        height = getScreenHeight();
        if (screen_width_percent != 0 && slide_height_percent != 0) {
