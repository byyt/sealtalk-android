...
import cn.yunchuang.im.server.network.async.AsyncTaskManager;
...
import cn.yunchuang.im.ui.activity.AboutRongCloudActivity;
import cn.yunchuang.im.ui.activity.AccountSettingActivity;
 ...
 * Company RongCloud
 */
public class MineFragment_new_old extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.start_user_profile:
                startActivity(new Intent(getActivity(), MyBaseInfoActivity_new.class));
                break;
