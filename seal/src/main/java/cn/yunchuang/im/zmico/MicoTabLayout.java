...
public class MicoTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link MicoTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link MicoTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public interface OnTabAddedCallback {
    ...
    private OnTabAddedCallback onTabAddedCallback;
    ...
    public MicoTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MicoTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MicoTabLayout);

        mTabStrip.setSelectedIndicatorWidth(a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabIndicatorWidth, 0));
        mTabStrip.setIndicator(a.getDrawable(R.styleable.MicoTabLayout_micoTabIndicator));
        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabIndicatorHeight, 0));
        mTabStrip.setIndicatorStyleRounded(a.getBoolean(R.styleable.MicoTabLayout_micoTabIndicatorStyleRounded, false));
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.MicoTabLayout_micoTabIndicatorColor, 0));
        mTabStrip.setSelectedIndicatorMarginBottom(a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabIndicatorMarginBottom, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabPaddingBottom,
                mTabPaddingBottom);

        mTabTextAppearance = a.getResourceId(R.styleable.MicoTabLayout_micoTabTextAppearance,
                R.style.TextAppearance_Tab_Default);

        bottomDividerHeight = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabBottomDividerHeight, 0);
        if (bottomDividerHeight > 0) {
            int bottomDividerColor = a.getColor(R.styleable.MicoTabLayout_micoTabBottomDividerColor, Color.TRANSPARENT);
            bottomDividerPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        ...
        if (a.hasValue(R.styleable.MicoTabLayout_micoTabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.MicoTabLayout_micoTabTextColor);
        }

        if (a.hasValue(R.styleable.MicoTabLayout_micoTabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.MicoTabLayout_micoTabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(R.styleable.MicoTabLayout_micoTabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(R.styleable.MicoTabLayout_micoTabContentStart, 0);
        mMode = a.getInt(R.styleable.MicoTabLayout_micoTabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.MicoTabLayout_micoTabGravity, GRAVITY_FILL);
        a.recycle();

        // TODO add attr for these
        DisplayMetrics dm = getResources().getDisplayMetrics();
        mTabTextMultiLineSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, dm);
        mScrollableTabMinWidth = Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 72, dm));
    ...
    /**
     * Add a {@link MicoTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     * <p>
    ...
    /**
     * Remove the given {@link MicoTabLayout.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link MicoTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link MicoTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link MicoTabLayout} with a {@link ViewPager}.
     * <p>
    ...
    private void addTabView(Tab tab) {
        ...
        if (onTabAddedCallback != null) {
            onTabAddedCallback.onTabAdded(tab);
        }
...
//        }
    ...
    public void setOnTabAddedCallback(OnTabAddedCallback callback) {
        onTabAddedCallback = callback;
    }
    ...
    public static final class Tab {
        ...
        public TextView getTabTextView() {
            return mView != null ? mView.mTextView : null;
        }
    ...
    static ImageView newIcon(Context context) {
        ImageView iv = new ImageView(context);
        iv.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        DisplayMetrics dm = context.getResources().getDisplayMetrics();
        int size = Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24, dm));
        iv.setLayoutParams(new ViewGroup.LayoutParams(size, size));
        return iv;
    }

    static TextView newText(Context context) {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        final void update() {
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = newIcon(getContext());
                    addView(iconView, 0);
                    mIconView = iconView;
                }
                if (mTextView == null) {
                    TextView textView = newText(getContext());
                    addView(textView);
                    mTextView = textView;
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void setSelectedIndicatorWidth(int width) {
            mSelectedIndicatorWidth = width < 0 ? 0 : width;
        }

        void setIndicator(Drawable indicator) {
            indicatorDrawable = indicator;
        }

        void setSelectedIndicatorMarginBottom(int margin) {
            if (mSelectedIndicatorMarginBottom != margin) {
                mSelectedIndicatorMarginBottom = margin;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }

        public void setIndicatorStyleRounded(boolean rounded) {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ValueAnimator animator = mIndicatorAnimator = ValueAnimator.ofFloat(0f, 1f);
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (mSelectedIndicatorWidth > 0) {
                    int cx = (right + left) / 2;
                    left = cx - mSelectedIndicatorWidth / 2;
                    right = cx + mSelectedIndicatorWidth / 2;
                }
                int height = getHeight();
                if (bottomDividerPaint != null) {
                    canvas.drawRect(0, height - bottomDividerHeight, MicoTabLayout.this.getWidth(), height, bottomDividerPaint);
                }

                int top = height - mSelectedIndicatorHeight - mSelectedIndicatorMarginBottom;
                int bottom = height - mSelectedIndicatorMarginBottom;
                if (indicatorDrawable != null) {
                    ...
                    if (rounded) {
                        ...
                        canvas.drawLine(left, y, right, y, mSelectedIndicatorPaint);
                    } else {
     ...
     * necessary calls back to the provided {@link MicoTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<MicoTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        TabLayoutOnPageChangeListener(MicoTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final MicoTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link MicoTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements MicoTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(MicoTabLayout.Tab tab) {
            mViewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(MicoTabLayout.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(MicoTabLayout.Tab tab) {
            // No-op
        }
    }
