...
import cn.yunchuang.im.server.request.DismissGroupRequest;
...
import cn.yunchuang.im.server.request.SetFriendDisplayNameRequest;
import cn.yunchuang.im.server.request.SetGroupDisplayNameRequest;
import cn.yunchuang.im.server.request.SetGroupNameRequest;
...
import cn.yunchuang.im.server.response.DefaultConversationResponse;
import cn.yunchuang.im.server.response.DeleteFriendResponse;
import cn.yunchuang.im.server.response.DeleteGroupMemberResponse;
import cn.yunchuang.im.server.response.DismissGroupResponse;
import cn.yunchuang.im.server.response.FriendInvitationResponse;
import cn.yunchuang.im.server.response.GetBlackListResponse;
import cn.yunchuang.im.server.response.GetFriendInfoByIDResponse;
...
import cn.yunchuang.im.server.response.RemoveFromBlackListResponse;
