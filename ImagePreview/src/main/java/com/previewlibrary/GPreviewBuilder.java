...
public final class GPreviewBuilder {
    ...
    private PhotoClickListener photoClickListener;//我加的一个参数，主要是为了返回点击图片的位置
     ...
     * @return GPreviewBuilder
     * **/
    public GPreviewBuilder setOnPhotoClickListener(PhotoClickListener photoClickListener) {
    ...
    public void start() {
        ...
        BasePhotoFragment.photoClickListener = photoClickListener;
